...
const ActionButton = styled.button`
  background: ${props => props.color || '#2D5F4F'};
  color: white;
  border: none;
  padding: 6px 12px;
  border-radius: 6px;
                    ...
                    <ProductInfo>
                      ...
                      <ProductFooter>
                        ...
                        <ProductActions>
                          ...
                          <ActionButton color="#4CAF50">Buy</ActionButton>
                        </ProductActions>
                      </ProductFooter>
                    </ProductInfo>
                  </ProductCard>
        ...
        {activeTab === 'services' && (
          <>
            ...
            <EarningsCard>
              ...
              <div style={{ textAlign: 'center', marginTop: '8px', fontSize: '14px', color: '#1B5E20' }}>
                🎯 32.5% of Bali goal!
              </div>
            </EarningsCard>
          </>
