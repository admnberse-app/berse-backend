  ...
  return (
    <Container>
      ...
      <Header>
        ...
        <PartnershipBadge>Charity & Giving</PartnershipBadge>
      </Header>
      <Content>
        <ComingSoon>
          <ComingSoonIcon>🚧</ComingSoonIcon>
          <ComingSoonTitle>Coming Soon!</ComingSoonTitle>
          <ComingSoonText>Donation and charity platform is under development</ComingSoonText>
          <PartnershipInfo>Supporting communities through giving</PartnershipInfo>
        </ComingSoon>
      </Content>
      <MainNav activeTab="donate" onTabPress={(tab) => {
        switch (tab) {
