...
export const SocialEventsScreen: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <Header>
        ...
        <HeaderTitle>💝 Social Events</HeaderTitle>
        <PartnershipBadge>Community Feature</PartnershipBadge>
      </Header>
      <Content>
        <ComingSoon>
          <ComingSoonIcon>🚧</ComingSoonIcon>
          <ComingSoonTitle>Coming Soon!</ComingSoonTitle>
          <ComingSoonText>Social Events and community gatherings platform is under development</ComingSoonText>
