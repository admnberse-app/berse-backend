...
-- Add index for faster password version lookups during token verification
CREATE INDEX IF NOT EXISTS "user_security_passwordVersion_idx" ON "user_security"("passwordVersion");
